...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/shrill-sky-5385)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shrill-sky-5385
```

A live public deployment of this template is available at [https://shrill-sky-5385.templates.workers.dev](https://shrill-sky-5385.templates.workers.dev)
